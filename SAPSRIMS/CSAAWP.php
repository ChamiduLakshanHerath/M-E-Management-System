<?php include('awp_csa_process.php'); ?>
...
<body class="adminbody">
	<section id="sidenavbar">
		<nav class="navbar">
			...
			<ul class="nav">
				...
				<li>
					<a href="CSAAWP.php" class="active">Annual Work Plan</a>
				</li>
				<li>
	...
	<main>
		...
		<div class="awpviscard"><br>
			...
			<form method="post" action="awp_csa_process.php">
			...
			<table class="table table-striped" id="myTable">
				...
				<?php while ($row = mysqli_fetch_array($results)) { ?>
					<tr>
						...
						<td>
							<a href="CSAAWP.php?edit=<?php echo $row['awpid']; ?>" class="btn btn-info">Edit</a>
						</td>
						<td>
							<a href="awp_csa_process.php?del=<?php echo $row['awpid']; ?>" class="btn btn-danger">Delete</a>
						</td>
					</tr>
					<?php } ?>
			</table>
