<?php include('awp_dm_process.php'); ?>

<?php
    if (isset($_GET['edit'])) {
        $awpid = $_GET['edit'];
        $update = true;
        $result = mysqli_query($db, "SELECT * FROM dmawp WHERE awpid=$awpid");
...
<head>
	...
	<title>SAPSRI MS: Annual Work Plan</title>
...
<body class="adminbody">
	<section id="sidenavbar">
		<nav class="navbar">
			...
			<ul class="nav">
				<li><a href="DMPannel.php" >Home</a></li>
				<li>
					<a href="DMAWP.php" class="active">Annual Work Plan</a>
				</li>
				<li>
	...
	<main>
		...
		<h2 class="Awpheading">Disaster Management (DM)</h2>
		<?php
		...
		<div class="awpviscard"><br>
			...
			<form method="post" action="awp_dm_process.php">
		...
		<br>
		<br>
		<?php $results = mysqli_query($db, "SELECT * FROM dmawp"); ?>
			<br>
			...
			<table class="table table-striped" id="myTable">
				...
				<?php while ($row = mysqli_fetch_array($results)) { ?>
					<tr>
						...
						<td>
							<a href="DMAWP.php?edit=<?php echo $row['awpid']; ?>" class="btn btn-info">Edit</a>
						</td>
						<td>
							<a href="awp_dm_process.php?del=<?php echo $row['awpid']; ?>" class="btn btn-danger">Delete</a>
						</td>
