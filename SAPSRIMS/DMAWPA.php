<?php include('awp_dm_admin_process.php'); ?>
...
<body class="adminbody">
	<section id="sidenavbar">
		<nav class="navbar">
			...
			<ul class="nav">
				...
				<li>
					<a href="CSODatabase.php">Databases</a>
				</li>
				<li>
	...
	<main>
		...
		<div class="awpviscard"><br>
			...
			<form method="post" action="awp_dm_admin_process.php">
			...
			<table class="table table-striped" id="myTable">
				...
				<?php while ($row = mysqli_fetch_array($results)) { ?>
					<tr>
						...
						<td>
							<a href="DMAWPA.php?edit=<?php echo $row['awpid']; ?>" class="btn btn-info">Edit</a>
						</td>
						<td>
							<a href="awp_dm_admin_process.php?del=<?php echo $row['awpid']; ?>" class="btn btn-danger">Delete</a>
						</td>
