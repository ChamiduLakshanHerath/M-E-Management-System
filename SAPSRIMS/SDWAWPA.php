<?php include('awp_sw_admin_process.php'); ?>
...
<body class="adminbody">
	...
	<main>
		...
		<div class="awpviscard"><br>
			...
			<form method="post" action="awp_sw_admin_process.php">
			...
			<table class="table table-striped" id="myTable">
				...
				<?php while ($row = mysqli_fetch_array($results)) { ?>
					<tr>
						...
						<td>
							<a href="SDWAWPA.php?edit=<?php echo $row['awpid']; ?>" class="btn btn-info">Edit</a>
						</td>
						<td>
							<a href="awp_sw_admin_process.php?del=<?php echo $row['awpid']; ?>" class="btn btn-danger">Delete</a>
						</td>
